...
<!-- Modal -->
<div class="modal fade" id="modalEditAsignaturaCalificacion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form id="formEditAsignaturaCalificacion" class="asignaturaCalificacion">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="editAsignaturaCalificacion()">Guardar</button>
      </div>
    </div>
  </div>
</div>
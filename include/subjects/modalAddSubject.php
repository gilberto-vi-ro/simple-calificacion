      ...
      <div class="modal-body">
        <form id="formAddSubject">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="asignatura" placeholder="Ingrese la asignatura">
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-primary" onclick="addSubject()">Agregar</button>
      </div>
    </div>
  </div>
</div>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!-- Topbar  -->
            <?php $titleTopbar="Asignaturas"; include_once "include/topbar.php"; ?>
                
            <div class="main-content">
                
                <div class="row content-bg justify-content-center align-items-center">
                    ...
                    <div class="col-lg-4 col-md-12 p-0 text-center">
                        <div class="card" style="height:535px;">
                            <div class="row-flex card-title">
                                ...
                                <i class="fas fa-plus-circle" style="font-size: 20px;cursor:pointer" data-toggle="modal" data-target="#modalAddSubject"></i>
                            </div>
                            <div id="cardContent" class="card-content">
                                <!-- <div class="sl-item">
                                    ...
                                    <div class="sl-edit">
                                        <i class="fas fa-edit" data-toggle="modal" data-target="#modalEditSubject"></i>
                                        <i class="fas fa-trash-alt" data-toggle="modal" data-target="#modalDeleteSubject"></i>
                                    </div>
                                </div> -->
                            </div>
                        </div>
                ...
                <!-- modalAddSubject -->
                <?php include_once "include/subjects/modalAddSubject.php" ?>
                <!-- modalEditSubject -->
                <?php include_once "include/subjects/modalEditSubject.php" ?>
                <!-- modalDeleteSubject -->
                <?php include_once "include/subjects/modalDeleteSubject.php" ?>
            </div>
        </div>
    </div>
